...
from ArticleSpider.tools.yundama_requests import ydm
...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        cookies = pickle.load(open('E:/git/ArticleSpider/ArticleSpider/cookies/zhihu.cookie', 'rb'))
        cookie_dict = {}
        ...
        #
        # pickle.dump(cookies, open('E:/git/ArticleSpider/ArticleSpider/cookies/zhihu.cookie', 'wb'))
        #
        #
        #
    ...
    #     try:
    #         im = Image.open('image/captcha.jpg')
    #         im.show()
    #         im.close()
